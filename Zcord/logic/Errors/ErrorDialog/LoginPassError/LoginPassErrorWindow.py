# Form implementation generated from reading ui file 'LoginPassError.ui'
#
...
"border:3px solid #BB271A;")
        ...
        self.ErrorMes.setMaximumSize(QtCore.QSize(200, 20))
        self.ErrorMes.setStyleSheet("font-size:20px;\n"
"color:white;")
        self.ErrorMes.setObjectName("ErrorMes")
        self.verticalLayout_2.addWidget(self.ErrorMes, 0, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignVCenter)
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ErrorMes.setText(_translate("Dialog", "Пароль не верный"))
        self.pushButton.setText(_translate("Dialog", "Окей"))
