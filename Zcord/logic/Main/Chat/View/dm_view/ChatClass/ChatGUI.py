...
"color:white;")
        ...
        self.horizontalFrame = QtWidgets.QFrame(parent=self.TopBar_2)
        self.horizontalFrame.setMaximumSize(QtCore.QSize(90, 50))
        ...
        self.TopBar.addWidget(self.horizontalFrame)
...
"border:3px solid white;")
        ...
        self.InviteToGroup = QtWidgets.QPushButton(parent=self.CallAndInfoButtons)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.InviteToGroup.sizePolicy().hasHeightForWidth())
        self.InviteToGroup.setSizePolicy(sizePolicy)
        self.InviteToGroup.setMinimumSize(QtCore.QSize(45, 45))
        self.InviteToGroup.setMaximumSize(QtCore.QSize(40, 40))
        self.InviteToGroup.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.InviteToGroup.setStyleSheet("background-color:r#BB271A;\n"
"border:none;\n"
"border-radius:15%;\n"
"border:3px solid white;")
        self.InviteToGroup.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("GUI/icon/group_add_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.InviteToGroup.setIcon(icon1)
        self.InviteToGroup.setIconSize(QtCore.QSize(30, 30))
        self.InviteToGroup.setObjectName("InviteToGroup")
        self.horizontalLayout_5.addWidget(self.InviteToGroup)
