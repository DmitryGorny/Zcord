...
class Ui_Group(object):
    def setupUi(self, Group):
        ...
        self.GroupIcon = QtWidgets.QPushButton(parent=self.UserIconAndNickInChat)
...
"")
        ...
        self.LogoAndNickName.addWidget(self.GroupIcon)
        self.GroupName = QtWidgets.QLabel(parent=self.UserIconAndNickInChat)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"color:white;")
        ...
        self.LogoAndNickName.addWidget(self.GroupName)
        ...
        self.TopBar.addWidget(self.horizontalFrame_2)
