# Form implementation generated from reading ui file 'SuccessRegister.ui'
#
...
class Ui_SuccessRegister(object):
    def setupUi(self, SuccessRegister):
        SuccessRegister.setObjectName("SuccessRegister")
        SuccessRegister.resize(450, 200)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(SuccessRegister.sizePolicy().hasHeightForWidth())
        SuccessRegister.setSizePolicy(sizePolicy)
        SuccessRegister.setMinimumSize(QtCore.QSize(450, 200))
        SuccessRegister.setMaximumSize(QtCore.QSize(450, 200))
        self.Wrapper = QtWidgets.QFrame(parent=SuccessRegister)
...
"border:3px solid #78A75A;")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("GUI/icon/done_outline_40dp_78A75A_FILL0_wght400_GRAD0_opsz40.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.ErrorMes.setMinimumSize(QtCore.QSize(0, 0))
        self.ErrorMes.setMaximumSize(QtCore.QSize(300, 20))
        self.ErrorMes.setStyleSheet("font-size:20px;\n"
"color:white;")
        self.ErrorMes.setObjectName("ErrorMes")
        self.verticalLayout_2.addWidget(self.ErrorMes, 0, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignBottom)
        ...
        self.Ok_button = QtWidgets.QPushButton(parent=self.Wrapper)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.verticalLayout.addWidget(self.Ok_button, 0, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignBottom)

        self.retranslateUi(SuccessRegister)
        QtCore.QMetaObject.connectSlotsByName(SuccessRegister)

    def retranslateUi(self, SuccessRegister):
        _translate = QtCore.QCoreApplication.translate
        SuccessRegister.setWindowTitle(_translate("SuccessRegister", "Dialog"))
        self.ErrorMes.setText(_translate("SuccessRegister", "Вы успешно зарегестрированы"))
        self.Ok_button.setText(_translate("SuccessRegister", "Окей"))
