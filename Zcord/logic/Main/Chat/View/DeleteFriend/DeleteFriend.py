...
from logic.Main.Chat.View.DeleteFriend.DeleteFriendGUI import Ui_DeleteFriend
...
class DeleteFriend(QtWidgets.QDialog):
    ...
    def __init__(self, chat):
        ...
        self.ui.Delete_button.clicked.connect(lambda x: self.deleteFriend())
        self.ui.Block_button.clicked.connect(lambda x: self.blockFriend())
    ...
    def deleteFriend(self):
        self._chat.rejectRequest(True)
        self.closeWindow()

    def blockFriend(self):
        self._chat.blockUser()
        self.closeWindow()
